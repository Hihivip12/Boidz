...
from rich.live import Live  # ✅ THÊM DÒNG NÀY Ở ĐẦU FILE
import threading
def play_music():
...
def delay_block(value):
    while not (value <= 1):
        value -= 0.123
        print(f'''\033[1;39m[\033[1;36mBOIZ\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[:5]}\033[1;39m][\033[1;33mX  \033[1;39m ]''', '               ', end='\r')
        sleep(0.025)
        print(f'''\033[1;39m[\033[1;36mBOIZ\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[:5]}\033[1;39m][\033[1;33m X   \033[1;39m]''', '               ', end='\r')
        sleep(0.025)
        print(f'''\033[1;39m[\033[1;36mBOIZ\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[:5]}\033[1;39m][ \033[1;33m  X  \033[1;39m]''', '               ', end='\r')
        sleep(0.025)
        print(f'''\033[1;39m[\033[1;36mBOIZ\033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[:5]}\033[1;39m][\033[1;33m   X \033[1;39m]''', '               ', end='\r')
...
def Main():
    ...
    while True:
        ...
        for ck in listck:
            ...
            ptool = 0
            while True:
                nvlikevip = 1 if '1' in str(nhiemvu) else 0
                nvreacvip = 1 if '2' in str(nhiemvu) else 0
                nvreaccmt = 1 if '3' in str(nhiemvu) else 0
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            try:
                                ...
                                countdown(6)
                            try:
                                getuid = requests.post('https://id.traodoisub.com/api.php', data={'link': link}, timeout=10)
                                data = getuid.json()
                                if 'success' in data:
                                    uuid = data['id']
                                else:
                                ...
                                sleep(1)
                                delay_block(2.5)
                            like = _Like(ck, id, "LIKE", _info[0], _info[1])
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}LIKE{do} | {trang}ẨN ID{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))} {do}| {xanh}{user}')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            try:
                                ...
                                sleep(1)
                                delay_block(2.5)
                            like = _Like(ck, id, typee, _info[0], _info[1])
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}ẨN ID{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))} {do}| {xanh}{user}')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                ...
                if nvreaccmt == 1:
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            like = _React_Cmt(ck, _info[1], _info[0], id, typee)
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}ẨN ID{do} | {vang}+600{do} | {luc}{str(format(int(xu),","))} {do}| {xanh}{user}')
                                    loicxcmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
